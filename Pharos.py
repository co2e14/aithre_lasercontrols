...
response = requests.put(laserEndPoint + "/v0/Basic/SelectedPresetIndex", data = json.dumps(1), headers = requestHeaders )
if response.status_code == 200:
    # Operation succeeded.
...
response = requests.post(laserEndPoint + "/v0/Basic/ApplySelectedPreset", headers = requestHeaders)
if response.status_code == 200:
    # Operation succeeded.
...
response = requests.post(laserEndPoint + "/v0/Basic/GoToStandby", headers = requestHeaders)
